...
static const f64 DEFAULT_LISTENER_DISTANCE_M = 4.5;
static const f64 DEFAULT_LISTENER_MOUTH_PRESSURE_MIX = 0.18;
static const f64 DEFAULT_LISTENER_CROSSFEED = 0.12;
static const f64 DEFAULT_LISTENER_LOWPASS_CUTOFF_HZ = 2800.0;
...
)
{
    ...
    (void) Fdtd1D_SetJetLabiumParameters(&source->solver, parameters);
}
