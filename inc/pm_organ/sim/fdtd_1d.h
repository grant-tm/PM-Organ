...
typedef struct Fdtd1DState
{
    ...
    f32 left_open_reflection_filter_fast_a1;
    f32 left_open_reflection_filter_fast_b0;
    f32 left_open_reflection_filter_fast_b1;
    f32 left_open_reflection_filter_mix;
    f32 right_open_reflection_filter_a1;
    f32 right_open_reflection_filter_b0;
    f32 right_open_reflection_filter_b1;
    f32 right_open_reflection_filter_fast_a1;
    f32 right_open_reflection_filter_fast_b0;
    f32 right_open_reflection_filter_fast_b1;
    f32 right_open_reflection_filter_mix;
    f32 left_previous_outgoing_pressure;
    f32 left_previous_incoming_pressure;
    f32 left_previous_fast_outgoing_pressure;
    f32 left_previous_fast_incoming_pressure;
    f32 right_previous_outgoing_pressure;
    f32 right_previous_incoming_pressure;
    f32 right_previous_fast_outgoing_pressure;
    f32 right_previous_fast_incoming_pressure;
